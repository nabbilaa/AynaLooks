                 ...
                 <div class="container py-5">
                     ...
                     <div class="profile-card" data-aos="fade-up" data-aos-delay="100">
                         <div class="profile-info">
                             ...
                             <p><i class="bi bi-person-circle"></i> Nama Penerima: {{ $user->nama_penerima ?? 'Belum diatur' }}</p>
                             <p><i class="bi bi-whatsapp"></i> Nomor WhatsApp: {{ $user->nomor_whatsapp ?? 'Belum diatur' }}</p>
                             <p><i class="bi bi-geo-alt-fill"></i> Alamat Pengiriman: {{ $user->alamat_pengiriman ?? 'Belum diatur' }}</p>
                                 ...
                                 <div class="modal-body">
                                     <form action="{{ route('profile.update') }}" method="POST">
                                         ...
                                         <div class="mb-3">
                                             ...
                                             <input type="text" class="form-control" id="nama_penerima" name="nama_penerima" value="{{ $user->nama_penerima ?? '' }}" required>
                                         </div>
                                         <div class="mb-3">
                                             <label for="nomor_whatsapp" class="form-label">Nomor WhatsApp</label>
                                             <input type="tel" class="form-control" id="nomor_whatsapp" name="nomor_whatsapp" value="{{ $user->nomor_whatsapp ?? '' }}" required>
                                         </div>
                                         <div class="mb-3">
                                             <label for="alamat_pengiriman" class="form-label">Alamat Pengiriman</label>
                                             <textarea class="form-control" id="alamat_pengiriman" name="alamat_pengiriman" required>{{ $user->alamat_pengiriman ?? '' }}</textarea>
                                         </div>
